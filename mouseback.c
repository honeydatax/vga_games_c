...
static unsigned char target_bits[] = {
   0x3c, 0x3c, 0x3c, 0x3c, 0x3c, 0x7e, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7e,
   0x3c, 0x3c, 0x3c, 0x3c};
...
static unsigned char mask_bits[] = {
   ...
   0xff, 0xff, 0xff, 0xff};
	...
	for (n=0;n<4;n++){
			setcolor(4);		
			graphics (objs[n].x,objs[n].y,target_width,target_height,target_bits);
			setcolor(blue);		
			graphics (objs[n].x,objs[n].y,mask_width,mask_height,mask_bits);
	}
	n=0;
	nn=0;
	cc=c+1;
	...
	while(n!=27){
		if (xxx!=xxx1 || yyy!=yyy1){
			...
			for (n=0;n<4;n++){
				if(xxx1>objs[n].x-16 && xxx1<objs[n].x+16 && yyy1>objs[n].y-16 && yyy1<objs[n].y+16){
					setcolor(4);		
					graphics (objs[n].x,objs[n].y,target_width,target_height,target_bits);
					setcolor(blue);		
					graphics (objs[n].x,objs[n].y,mask_width,mask_height,mask_bits);
			...
			setcolor(15);		
			graphics (xxx,yyy,cursor_width,cursor_height,cursor_bits);
			setcolor(blue);		
