...
static unsigned char mask_bits[] = {
   ...
   0xff, 0xff, 0xff, 0xff};
	...
	for (n=0;n<10;n++){
		setcolor(15);		
		graphics ((n+1)*32,n*3,ship_width,ship_height,ship_bits);
		setcolor(blue);		
		graphics ((n+1)*32,n*3,mask_width,mask_height,mask_bits);
		sleep(15);
		setcolor(15);		
		invgraphics ((n+1)*32,n*3,mask_width,mask_height,mask_bits);
		setcolor(blue);
		graphics ((n+1)*32,n*3,mask_width,mask_height,mask_bits);
	}
